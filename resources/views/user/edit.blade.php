<x-home-master>
    ...
    <form action="{{route('users.update', $user)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card mb-4 " style="margin-top: 8%; padding-left:4%; padding-right:4%;">
            ...
            <label for="image" class="d-flex justify-content-end">
                <img class="img-profile rounded-circle" style="margin-right: 10%; width:10%" src="{{asset('storage/images/'.$user->profile_image)}}">
            </label>
            <input type="file" id="image" name="image" style="display: none;">
            <cite class="d-flex justify-content-end" style="width:95%">click on image to edit</cite>
            @error('image')
