    ...
    @section('content')
        ...
        <form action="{{route('permissions.store')}}" method="POST">  
            ...
            <div class="form-group mx-auto" style="width: 30%; margin-top:3%">
                ...
                <input type="text" id="name" placeholder="Enter name" name="name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror">
            </div>
            @error('name')
            ...
            <div class="form-group mx-auto" style="width: 30%;">
                ...
                <input type="text" id="slug" placeholder="Enter slug" name="slug" value="{{old('slug')}}" class="form-control @error('slug') is-invalid @enderror">
            </div>
            @error('slug')
            <div class="form-group mx-auto" style="width: 30%">
                <strong class="text-danger">{{$message}}</strong>
