<x-admin-master>
    ...
    <form action="{{route('permissions.update', $permission)}}" method="POST">  
        ...
        <div class="form-group mx-auto" style="width: 30%; margin-top:3%">
            ...
            <input type="text" id="name" placeholder="Enter name" name="name" value="{{$permission->name}}" class="form-control @error('name') is-invalid @enderror">
        </div>
        @error('name')
        ...
        <div class="form-group mx-auto" style="width: 30%;">
            ...
            <input type="text" id="slug" placeholder="Enter slug" name="slug" value="{{$permission->slug}}" class="form-control @error('slug') is-invalid @enderror">
        </div>
        @error('slug')
        <div class="form-group mx-auto" style="width: 30%">
            <strong class="text-danger">{{$message}}</strong>
